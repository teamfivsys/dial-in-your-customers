...
export const aeoFaqs: FAQItem[] = [
  {
    ...
    answer: "KDIAL is Kerala's first premium-only business directory. Unlike free directories filled with spam and outdated listings, KDIAL only lists verified, quality businesses. Every business on KDIAL pays ₹501/year, ensuring only serious, customer-focused businesses are featured. Think of it as the 'premium club' for Kerala businesses – no fake listings, no spam calls, just genuine local businesses you can trust."
  },
  {
  ...
  },
  {
    ...
    answer: "Listing your business on KDIAL is simple: 1) Click 'Pre-Book on WhatsApp' on kdial.in 2) Share your business name, category, and location 3) Pay ₹501 via UPI or bank transfer 4) Submit your business details and photos. Your listing goes live when KDIAL launches in your city. Currently, KDIAL is accepting pre-bookings for Ernakulam district with only 100 Founder Slots available at the special ₹501 price."
  },
  {
    question: "What is a Founder Slot on KDIAL?",
    answer: "A Founder Slot is one of the first 100 business listings on KDIAL at a special founding price of ₹501/year. Founder Slot benefits include: 1) Lowest price ever – ₹501/year (future price will be higher) 2) Priority placement in search results 3) 'Founding Member' badge on your listing 4) Early access before competitors. Only 100 Founder Slots are available for Ernakulam district. Once filled, new listings will cost more."
  },
  {
