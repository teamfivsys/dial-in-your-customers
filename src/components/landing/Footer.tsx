    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.18em] text-foreground mb-3">Explore</h3>
            <ul className="space-y-2">
              <li><a href="/" className={linkCls}>Home</a></li>
              <li><a href="/blog" className={linkCls}>Blog</a></li>
              <li><a href="/#why-kdial" className={linkCls}>Why KDial</a></li>
              <li><a href="/#privacy" className={linkCls}>Privacy</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.18em] text-foreground mb-3">Cities</h3>
            <ul className="space-y-2">
              <li><a href="/kochi" className={linkCls}>Kochi</a></li>
              <li><a href="/trivandrum" className={linkCls}>Trivandrum</a></li>
              <li><a href="/calicut" className={linkCls}>Calicut</a></li>
              <li><a href="/thrissur" className={linkCls}>Thrissur</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.18em] text-foreground mb-3">Get in touch</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href={WHATSAPP_URL}
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-muted-foreground flex items-center gap-1">
            Made in Kerala with <span className="text-[#FF6B1A]" aria-hidden="true">❤️</span>
          </p>
        </div>
      </div>
    </motion.footer>
